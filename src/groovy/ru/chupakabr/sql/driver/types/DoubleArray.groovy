...
/**
 * Support for PostgreSQL double precision[] type
 *
 * Created by myltik on 07/03/2014.
 */
class DoubleArray extends AbstractPostgresType {

    /**
     * JDBC type definition
     */
    public static final SQL_TYPES = [PostgreSQLTypes.ARRAY_DOUBLE] as int[]
